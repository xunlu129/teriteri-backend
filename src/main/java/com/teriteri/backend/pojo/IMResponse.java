...
public class IMResponse {
    private String type;    // 消息类型 如："回复我的"，"@我的"，"收到的赞"，"系统通知"，"我的消息" / "system"
     ...
     * @return 返回系统失败消息
     */
    public static TextWebSocketFrame system(String message) {
        return new TextWebSocketFrame(JSON.toJSONString(new IMResponse("system", LocalDateTime.now(), message)));
    }

    /**
     * 非系统类消息
     * @param type  消息类型 如："回复我的"，"@我的"，"收到的赞"，"系统通知"，"我的消息"
     * @param data  返回的相关数据
